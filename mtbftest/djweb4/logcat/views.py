...
def child(request):
    localpath = os.getcwd()
    rootFolder = os.path.dirname(localpath) + '/apptest_tv'
    print("==============================================================================")
    ...
    self = HtmlReport(phoneDataList , totalFC , totalTB , totalANR , totalReset ,
                      str(totalExeTime) + "Hrs" , totalError , totalcasePass , totalcaseExce , passRate , mtbfVal)
