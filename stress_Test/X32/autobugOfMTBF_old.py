...
class LogParser():
    ...
    def parse_logstack(self,folder, projectName, buildPath):
        ...
        try:
            logfile = open(folder + LOG_STACK, "r")
            lines = logfile.readlines()
        except IOError as e:
            lines = ""
...
class Jira():
    ...
    def parseBugParameter(self, data):
        ...
        testPersonName = '周金娥'
        testPersonTell = '15712864566'
        testPersonEmail = 'zhoujine@le.com'
        ...
        if bugtype == 'FC':
            summary =  "["+projectName+":MTBF:"+ casenames+"]"+ "当" +"电视发生FC"
            description = "测试版本：" + buildPath.split("/")[-1] + '\n' + "测试机：" + projectName + '\n'\
                          + "【操作步骤】" + '\n' + casestep.rstrip() + "\n\n发生FC，log如下：" + '\n\n' + log.rstrip()\
                          +'\n'+"如有问题请联系\n姓名："+testPersonName+"\n电话："+testPersonTell+"\n电子邮箱："+testPersonEmail
        elif bugtype == 'ANR':
            summary = "["+projectName+":MTBF:"+ casenames+"]"+ pkg +"电视发生ANR"
            description = "测试版本：" + buildPath.split("/")[-1] + '\n' + "测试机：" + projectName + '\n'\
                          + "【操作步骤】" + '\n' + casestep.rstrip() + "\n\n发生ANR，log如下：" + '\n\n' + log.rstrip()\
                          +'\n'+"如有问题请联系\n姓名："+testPersonName+"\n电话："+testPersonTell+"\n电子邮箱："+testPersonEmail
        elif bugtype == 'Tombstone':
            summary = "[" + projectName + ":MTBF:" + casenames + "]" + pkg + "发生Tombstone"
            description = "测试版本：" + buildPath.split("/")[-1] + '\n' + "测试机：" + projectName + '\n'\
                          + "【操作步骤】" + '\n' + casestep.rstrip() + "\n\n发生Tombstone，log如下：" + '\n\n' + log.rstrip()\
                          +'\n'+"如有问题请联系\n姓名："+testPersonName+"\n电话："+testPersonTell+"\n电子邮箱："+testPersonEmail
        elif bugtype =='Reboot':
            summary = "[" + projectName + ":MTBF:Reboot]" + rebootname + "发生Reboot"
            description = "测试版本：" + buildPath.split("/")[-1] + '\n' + "测试机：" + projectName + '\n'\
                          + "【操作步骤】" + '\n' + casestep.rstrip() + "\n\n发生Reboot\n如有问题请联系\n姓名："\
                          +testPersonName+"\n电话："+testPersonTell+"\n电子邮箱："+testPersonEmail
