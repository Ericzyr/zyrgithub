...
class CsvReader():
	...
	def getProcessList(self):
		...
		topFile = open(path+"/Pss_Cpu/cmdline.txt","r") 
...
def main(argv):
	...
	if len(argv) != 4:
		...
		print "Usage:"
		print "python formatter.py <source.csv> <output.csv> <PicFolder>"
		sys.exit()
	cr = CsvReader(argv[1])
	...
	with open(argv[3].split(os.sep)[0]+"/pssPic.htm", 'w') as fp:
		fp.write(html)
	time2= time.time()
	print "convert finished. Cost time:"+str(time2-time1)+ " sec."
